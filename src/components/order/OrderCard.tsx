import { updateOrder } from "@/lib/actions/orders.actions";
import { OrdersProps } from "@/types/components";
import { formatCurrency } from "@/utils";
 
export default function OrderCard({ order }: OrdersProps) {
    return (
        <section
        ...
        >
            ...
            <form action={async () => await updateOrder(order._id)}>
                <input 
                    type="hidden"
                    value={order._id}
                    name="order_id"
